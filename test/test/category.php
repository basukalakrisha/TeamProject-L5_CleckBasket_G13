...
if (!isset($_SESSION['csrf_token'])) {
    ...
    error_log("category.php - Generated new CSRF token: " . $_SESSION['csrf_token']);
}
...
<div class="container mx-auto px-6 py-8">
    ...
    <?php if ($category_id): // Display products if a specific category is selected ?>
        ...
        <?php else: ?>
            <!-- Message handled by top section -->
        <?php endif; ?>
    <?php elseif (!empty($categories_list)): // Display all categories if no specific category ID ?>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <?php
                ...
                if ($category_item['CATEGORY_NAME'] === 'Bakery') {
                    $background_image = 'assets/images/Bakery.jpg';
                } elseif ($category_item['CATEGORY_NAME'] === 'Butchers') {
                    $background_image = 'assets/images/Butchers.jpg';
                } elseif ($category_item['CATEGORY_NAME'] === 'Delicatessen') {
                    $background_image = 'assets/images/Delicatessen.jpg';
                }elseif ($category_item['CATEGORY_NAME'] === 'Fishmonger') {
                    $background_image = 'assets/images/Fishmonger.jpg';
                }elseif ($category_item['CATEGORY_NAME'] === 'Greengrocer') {
            ...
            <div class="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-xl transition duration-300 relative" style="background-image: url('<?php echo $background_image; ?>'); background-size: cover; background-position: center;">
                ...
                <div class="relative z-10">
                    <h3 class="text-xl font-semibold text-white mb-2"><?php echo htmlspecialchars($category_item['CATEGORY_NAME']); ?></h3>
                    <p class="text-sm text-gray-200 mb-4"><?php echo htmlspecialchars($category_item['PRODUCT_COUNT']); ?> products</p>
